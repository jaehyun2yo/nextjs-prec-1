            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              ...
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  패키지명을 작성시에는 추후에 작업현황을 확인하실수있도록 알아보기쉽게 작성하면
                  편리합니다!
                </p>
              </div>
            </div>
                ...
                {deliveryMethod === 'delivery_company' && (
                  <div className="space-y-6">
                    ...
                    {isCompanyLoggedIn === true && (
                      <div className="mb-6">
                        <label
                          htmlFor="saved_delivery_company"
                          className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2"
                        >
                          저장된 납품처
                        </label>
                      ...
                      <div className="my-6">
                        <InfoBox>
                          <p className="text-xs text-gray-900 dark:text-gray-100">
                            <Link
                              href="/register"
                              className="underline !text-[#ED6C00] dark:!text-[#ff8533] hover:!text-[#d15f00] dark:hover:!text-[#ff8533] transition-colors font-medium"
                            >
                              업체 등록
                            </Link>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <label
                          htmlFor="delivery_company_phone"
                          className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2"
                        >
                          연락처 <span className="text-red-500">*</span>
                        </label>
                      ...
                      <div>
                        <label
                          htmlFor="delivery_company_address"
                          className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2"
                        >
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                입력하신 내용을 확인해주세요. 수정이 필요하시면 해당 섹션의 수정 버튼을
                클릭해주세요.
              </p>
                  ...
                  onClick={async (e) => {
                    ...
                    try {
                      ...
                      formData.append(
                        ...
                        serviceType === 'moldRequest' ? '1' : '0'
                      );
                      formData.append(
                        'service_delivery_brokerage',
                        serviceType === 'deliveryBrokerage' ? '1' : '0'
                      );
